...
//        AudioBufferList.
    ...
    AudioUnitSampleType *outSamplesChannelRight = nil;
...
- (void) readAudioFilesIntoMemory {
    ...
    for (int audioFile = 0; audioFile < NUM_FILES; ++audioFile)  {
        ...
        soundStructArray[audioFile].frameCount = (int)totalFramesInFile;
        ...
        (AudioUnitSampleType *) calloc ((int)totalFramesInFile, sizeof (AudioUnitSampleType));
        ...
        bufferList->mBuffers[0].mDataByteSize    = (unsigned long)totalFramesInFile * sizeof (AudioUnitSampleType);
        bufferList->mBuffers[0].mData            = soundStructArray[audioFile].audioDataLeft;
        
        if (2 == channelCount) {
            bufferList->mBuffers[1].mNumberChannels  = 1;
            bufferList->mBuffers[1].mDataByteSize    = (unsigned long)totalFramesInFile * sizeof (AudioUnitSampleType);
